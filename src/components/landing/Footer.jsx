      ...
      <div className="w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-cormorant font-bold text-2xl tracking-wide">GraceTrack</span>
            </div>
        ...
        <div className="pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 font-dmsans text-sm">
            © {new Date().getFullYear()} GraceTrack. All rights reserved.
          </p>
          <p className="flex items-center gap-2 font-dmsans text-sm text-gray-500">
            Made with <span className="text-teal-400">♥</span> for the Church
          </p>
        </div>
      </div>
    </footer>
